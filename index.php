...
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
        ...
        The lollipop farm
            ...
            <div>
                <button class="home_button" id="saveButton" onClick="save();" style="visibility:visible"><b>Save</b></button>&nbsp;&nbsp;&nbsp;<button class="home_button" id="loadButton" onClick="loadPrompt();" style="visibility:visible"><b>Load</b></button><span id="save"></span><br/><br/>
